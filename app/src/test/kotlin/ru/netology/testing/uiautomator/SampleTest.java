...
public class SampleTest {
    ...
    public void sampleTest() {
        ...
        WebElement el2 = driver.findElement(AppiumBy.id("ru.netology.testing.uiautomator:id/buttonChange"));
        el2.isDisplayed();
        el2.click();

        WebElement el3 = driver.findElement(AppiumBy.id("ru.netology.testing.uiautomator:id/textToBeChanged"));
        el3.isDisplayed();
        el3.click();
